        ...
        >
          ...
          <div className="flex items-center gap-1 sm:hidden">
            ...
            <button
              ...
              className="neu-surface liquid-glass-sm flex h-10 w-10 items-center justify-center rounded-full text-ink"
            >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="liquid-glass-panel absolute left-4 right-4 top-[calc(100%+0.5rem)] rounded-3xl border border-line bg-midnight/90 p-3 shadow-[0_16px_48px_rgba(0,0,0,0.6)] backdrop-blur-2xl sm:hidden"
          >
            <ul className="flex flex-col gap-1">
              {links.map((link) => (
                <li key={link.href}>
                  <a
                    ...
                    className="liquid-glass-sm block rounded-2xl px-4 py-3 text-sm font-medium text-ink-soft transition-colors hover:bg-glass/70 hover:text-ink active:bg-glass/70"
                  >
                    {link.label}
                  </a>
                </li>
              ...
              <li>
                <a
                  ...
                  download
                  onClick={() => setOpen(false)}
                  className="neu-surface-sm liquid-glass-sm mt-1 flex items-center justify-center gap-2 rounded-2xl border border-line px-4 py-3 text-center text-sm font-medium text-ink-soft"
                >
              ...
              <li>
                <a
                  href="#contact"
                  onClick={() => setOpen(false)}
                  className="neu-surface-sm liquid-glass-sm mt-1 block rounded-2xl bg-gradient-to-r from-indigo to-purple px-4 py-3 text-center text-sm font-semibold text-white"
                >
                  Hire Me
                </a>
              </li>
